...
Runtimes that currently use it as their health monitoring implementation include: *Quarkus*, WildFly, Thorntail

Types of healthiness checks: Liveness, Readiness, Startup
