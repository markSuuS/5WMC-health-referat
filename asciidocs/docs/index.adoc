...
`/q/health-ui` allows you to see your Health Checks in a Web GUI.
...
https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/[More]